    ...
    <>
      {cartPrdt && cartPrdt.quantity > 0 && (
        <Link
          ...
          className={`flex gap-x-5 rounded-xl shadow-md transition-all duration-100 hover:scale-105 `}
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-x-5">
                <button
                  ...
                  className={`z-10 shrink-0  rounded-full px-2 text-lg
                  ${
                ...
                <p className="w-6">{cartPrdt && cartPrdt.quantity}</p>
                <button
                  disabled={isMutating}
